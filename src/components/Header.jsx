  ...
  return (
    <Navbar fluid className="fixed top-0 w-full z-50 bg-white shadow-md">
      ...
      <Navbar.Collapse>
        {isLoggedIn && (
          <NavLink to="/products">
            <Navbar.Link style={{ color: 'var(--secondary-color)' }} active>My products</Navbar.Link>
          </NavLink>
        )}
        {isLoggedIn && (
          <NavLink to="/costs">
            <Navbar.Link style={{ color: 'var(--secondary-color)' }} active>My costs</Navbar.Link>
          </NavLink>
        )}
        <NavLink to="/about">
          <Navbar.Link style={{ color: 'var(--secondary-color)' }} active>About</Navbar.Link>
        </NavLink>
      </Navbar.Collapse>
    </Navbar>
  );
